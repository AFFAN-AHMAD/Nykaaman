const nav = () => {
  ...
  >
    <defs>
      <path id="path-1" d="M.117.04H16.88v15.834H.117z"></path>
      <path id="path-3" d="M.095.04h15.842v15.834H.095z"></path>
      <path id="path-5" d="M.147.04h15.661v15.834H.147z"></path>
      <path id="path-7" d="M.203.04H16.86v15.834H.203z"></path>
      <path id="path-9" d="M.017.04h16.896v15.834H.017z"></path>
      <path id="path-11" d="M0 .064h30.988V25H0z"></path>
      <path id="path-13" d="M.242.064h26.702V25H.242z"></path>
      <path id="path-15" d="M.041.064H25.79V25H.041z"></path>
    </defs>
    <g
      id="web"
      stroke="none"
    ...
    <div class="second">
      <div class="cart">1 - CHECKOUT</div>
      <div class="ordersummary">2 - ADDRESS</div>
      <div class="payment">3 - PAYMENT</div>
    </div>
    <div></div>
    <div></div>
  </div>`;
