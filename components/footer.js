    ...
    <div id="footer">
        <div id="f1">
            <div class="f11">
                <div>
                    ...
                    <form class="formf111">
                        <input type="email" class="input" placeholder="Your Email" value="">
                ...
                <div class="f12">
                    ...
                    <div class="f123">
                        <p class="ig8bpr">FOR ANY HELP YOU MAY CALL US AT <br>1800-267-4444</p>
        ...
        <div id="f2">
            <div class="f21">
                ...
                <div class="f211">
                    <header>Help</header>
                    <ul class="f211ule">
                        <li class="f211li">Contact Us</li>
                        <li class="f211li">Frequently asked questions</li>
                        <li class="f211li">Store LOactor</li>
                        <li class="f211li">Cancellation & Return</li>
                        <li class="f211li">Shipping & delivery policy</li>
                    </ul>
                </div>
                <div class="f211">
                    <header>Quick Links</header>
                    <ul class="f211ule">
                        <li class="f211li">Brand Stores</li>
                        <li class="f211li">Offer Zone</li>
                        <li class="f211li">Sitemap</li>
                    </ul>
                </div>
                <div class="f211">
                    <header>Top Categories</header>
                    <ul class="f211ule">
                        <li class="f211lidouble">Shaving</li>
                        <li class="f211lidouble">Hair Care</li>
                        <li class="f211lidouble">Personal Care</li>
                        <li class="f211lidouble">Perfumes & Deos</li>
                        <li class="f211lidouble">Wellness</li>
                        <li class="f211lidouble">Beard Care</li>
                        <li class="f211lidouble">Skin Care</li>
                        <li class="f211lidouble">Kits & conbos</li>
                        <li class="f211lidouble">Sports Nutrition</li>
                        <li class="f211lidouble">Gifting</li>
                    </ul>
                </div>
                <div class="f211">
                    <header>Luxe</header>
                    <ul class="f211ule">
                        <li class="f211li">Bath and Body</li>
                        <li class="f211li">Hair</li>
                        <li class="f211li">Fragrance</li>
                        <li class="f211li">Skin</li>
                    </ul>
                </div>
            </div>
        ...
        <div id="f3">
            <div class="f31">
                <div class="f311">
                    <div class="f3111">
                        <img src="https://adn-static1.nykaa.com/media/listing/nykaaman/nykaaman_shipping.svg" alt="Free Shipping">
                        <div>
                            <div class="f31111">FreeShipping</div>
                            <div class="f31112">for orders above
                                INR<!-- -->499</div>
                        </div>
                    ...
                    <div class="f3111">
                        <img>
                        <div><div class="f31113"></div>
                        <div class="f31114"></div>
                        </div>
                    </div>
                    <div class="f3111">
                        <img src="https://adn-static1.nykaa.com/media/listing/nykaaman/nykaaman_genuine.svg" alt="brands count">
                        <div>
                            <div class="f31111">Authentic Products</div>
                            <div class="f31112">Sourced Directly from Brands/ Authorised Distributors</div>
                        </div>
                    </div>
                </div>
                <div class="f312">
                    <div class="f3121">show us some love on social media</div>
                    <ul class="f3122">
                        <li class="f312ul">
                            <a href="https://instagram.com/NykaaMan?ref=badge" target="_blank" rel="noopener noreferrer" class="f312ula">
                                <img src="https://adn-static1.nykaa.com/media/listing/nykaaman/nykaaman_insta.svg" alt="Instagram">
                            </a>
                        </li>
                        <li class="f312ul">
                            <a href="https://www.facebook.com/NykaaMan" target="_blank" rel="noopener noreferrer" class="f312ula">
                                <img src="https://adn-static1.nykaa.com/media/listing/nykaaman/nykaaman_fb.svg" alt="Facebook">
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div id="f4">
            <a href="/terms-conditions" target="_blank" rel="noopener noreferrer" class="f41">Terms &amp; Conditions</a>
            <a href="/shipping-policy" target="_blank" rel="noopener noreferrer" class="f41">Shipping Policy</a>
            <a href="/cancellation-policy" target="_blank" rel="noopener noreferrer" class="f41">Cancellation Policy</a>
            <a href="/privacy-policy" target="_blank" rel="noopener noreferrer" class="f41">Privacy Policy</a>
        </div>
        <div id="f5">
            <p class="f51"><span>©</span> <!-- -->2022<!-- --> Nykaa E-Retail Pvt. Ltd. All Rights Reserved.</p>
